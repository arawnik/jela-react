    ...
    <section className="container container-narrow text-center">
      ...
      <div className="timeline">
        {experiences
          ...
          : // Placeholder content for three experiences
            Array(3)
              .fill(null)
              .map((_, index) => (
                <div
                  ...
                  className="timeline-box row"
                >
                  {/* Left Side Placeholder for Era and Title */}
                  <div className="timeline-left col-md-6">
                    <p className="h4">
                  ...
                  {/* Right Side Placeholder for Company, Description, and Keywords */}
                  <div className="timeline-right col-md-6">
                    <p className="h4">
                      <span className="placeholder col-4"></span>
                    </p>
                    ...
                    {/* Placeholder for Collapsible Keywords */}
                    <fieldset className="collapsible">
